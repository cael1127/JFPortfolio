  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-10">
        ...
        <p className="text-gray-400 mb-6">March 2021 — May 2022</p>
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="md:col-span-2 bg-gray-800 p-6 rounded-xl border border-gray-700">
            <h2 className="text-xl font-semibold mb-3">Overview</h2>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>Restored vessel to working condition.</li>
              <li>Fabricated custom brackets to reduce cost.</li>
              <li>Coordinated repairs and material sourcing.</li>
            </ul>
          </div>
        ...
        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
          ...
          <p className="text-gray-400">Add photos here (public/boat-*.jpg) and reference them.</p>
        </div>
      </div>
    </div>
  );
